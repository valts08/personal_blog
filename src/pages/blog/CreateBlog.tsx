    ...
    return (
        <>
            <section className="py-10">
                ...
                <div className="pb-5">
                    <input className="block p-2 border rounded-md border-gray-300 bg-white" type="text" placeholder="Title" onChange={(e) => dispatch({type: 'TITLE', data: e.target.value})}/>
                    <input className="block p-2 mt-4 border rounded-md border-gray-300 bg-white" type="text" placeholder="Summary" onChange={(e) => dispatch({type: 'PREVIEW', data: e.target.value})}/>
                    <textarea className="block mt-4 p-2 min-w-8/10 min-h-[250px] border rounded-md border-gray-300 bg-white resize" placeholder="Start writing your blog..." onChange={(e) => dispatch({type: 'CONTENT', data: e.target.value})}/>
                </div>
